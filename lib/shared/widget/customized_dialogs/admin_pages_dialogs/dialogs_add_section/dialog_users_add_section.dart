...
class DialogUsersAddSection extends StatefulWidget {
  const DialogUsersAddSection({
    Key? key,
  }) : super(key: key);

  @override
  State<DialogUsersAddSection> createState() => _DialogUsersAddSectionState();
}

class _DialogUsersAddSectionState extends State<DialogUsersAddSection> {
  @override
